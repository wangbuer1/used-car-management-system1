...
//    }
    ...
    @Override
    public Admin checkAdminLogin(String username, String password){
        System.out.println("数据 ==="+username+" "+password);
        User user = userdao.selectByUsernameForAdmin(username);
        System.out.println("测试："+user.getUname()+" "+user.getUpassword());
